...
public class ConfigHandler {
	...
	public static void init(Configuration config) {
		...
		enablePlayerEffects = config.get(general, "enablePlayerEffects", true, "Negative effects given to player if they enter a radiation zone.").getBoolean(true);
...
//		showOredictTooltips = config.get(debug, "showOredictTooltips", false, "For debugging porpoises. Adds tooltips to all registered items with their OreDictionary entry.").getBoolean(false);
		enableDebugTools = config.get(debug, "enableDebugTools", false, "For debugging porpoises. Adds some blocks/items for easy testing.").getBoolean(false);
