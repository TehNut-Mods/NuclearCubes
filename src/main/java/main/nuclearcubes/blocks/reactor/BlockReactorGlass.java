...
public class BlockReactorGlass extends Block {
	...
	public void registerBlockIcons (IIconRegister ir) {
		blockIcon = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_0");
		icons[0] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_0");
		icons[1] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_1");
		icons[2] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_2");
		icons[3] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_3");
		icons[4] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_4");
		icons[5] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_5");
		icons[6] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_6");
		icons[7] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_7");
		icons[8] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_8");
		icons[9] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_9");
		icons[10] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_10");
		icons[11] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_11");
		icons[12] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_12");
		icons[13] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_13");
		icons[14] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_14");
		icons[15] = ir.registerIcon(ModInformation.ID + ":machines/reactor/reactorGlass_15");
	}
}
